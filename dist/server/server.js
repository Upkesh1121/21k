...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DqHKQwSV.js");
...
const manifest = {
  "3d2e99b45e2882a4173fd21ceaa20ca741129ca5fa4868bce25b4278795eeeaf": {
    functionName: "getStripeEnabled_createServerFn_handler",
    importer: () => import("./assets/stripe-DcraSPR_.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-C-VpF-Zt.js").then((n) => n.r),
